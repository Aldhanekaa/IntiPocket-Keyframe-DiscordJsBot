...
const bot_activities = [
  { "name": "AI Powered Discord Bot", "activity": "Playing" },
  { "name": "to AKB48 ", "activity": "Listening" }
];

const bot_config = {
  "client_id": "1119201709034582107",
...
const app = new Bot(bot_config["client_id"], bot_config, process.env.DISCORD_BOT_TOKEN);
